...
declare module "@salesforce/apex/TelosTouchUtility.generateCustomizeIFrame" {
  export default function generateCustomizeIFrame(param: {templateId: any, campaignId: any, templateInfo: any}): Promise<any>;
}
...
declare module "@salesforce/apex/TelosTouchUtility.syncClientsBeforeTouchpoint" {
  export default function syncClientsBeforeTouchpoint(param: {campaignId: any}): Promise<any>;
}
